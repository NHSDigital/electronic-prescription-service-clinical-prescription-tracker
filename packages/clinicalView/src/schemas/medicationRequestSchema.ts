...
export const medicationRequestSchema = {
        ...
        oneOf: [
          {
            type: "object",
            properties: {
              url: {type: "string", enum: ["https://fhir.nhs.uk/StructureDefinition/Extension-EPS-DispensingInformation"]},
              extension: {
                type: "array",
                items: {
                  type: "object",
          ...
          },
          {
            type: "object",
            properties: {
              url: {type: "string", enum: ["https://fhir.nhs.uk/StructureDefinition/Extension-EPS-PendingCancellations"]},
              extension: {
                type: "array",
                items: {
                  oneOf: [
                    ...
                    },
                    {
                      ...
                      properties: {
                        ...
                        valueCoding: {
                          type: "object",
                          properties: {
                            system: {type: "string", enum: ["https://fhir.nhs.uk/CodeSystem/medicationrequest-status-reason"]},
                            code: {type: "string"},
                            display: {type: "string"}
                          },
                          required: ["system", "code", "display"]
  ...
  required: ["resourceType", "id", "status", "subject", "medicationCodeableConcept", "dispenseRequest", "dosageInstruction"],
