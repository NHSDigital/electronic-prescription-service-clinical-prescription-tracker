...
export const acuteMultipleDispenseNotifications = readXmlToString("acuteMultipleDispenseNotifications.xml")
export const altAcuteMultipleDispenseNotifications = readXmlToString("altAcuteMultipleDispenseNotifications.xml")
