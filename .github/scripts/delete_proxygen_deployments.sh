...
main() {
  ...
  delete_apigee_deployments "internal-dev" "clinical-prescription-tracker-api" "ClinicalTrackerProxygenPrivateKey" "eps-clinical-tracker"
  delete_apigee_deployments "internal-dev-sandbox" "clinical-prescription-tracker-api" "ClinicalTrackerProxygenPrivateKey" "eps-clinical-tracker"
}
