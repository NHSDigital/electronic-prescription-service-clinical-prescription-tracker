...
aws cloudformation deploy \
          ...
          --parameter-overrides SubjectClaimFilters="repo:NHSDigital/electronic-prescription-service-clinical-prescription-tracker:*,repo:NHSDigital/electronic-prescription-service-release-notes:*"
```
...
- route 53 hosted zone for {environment}.electronic-prescription-service-clinical-prescription-tracker.national.nhs.uk
...
- route 53 hosted zone for electronic-prescription-service-clinical-prescription-tracker.national.nhs.uk
- NS records for {dev, int, ref, qa, prod}.electronic-prescription-service-clinical-prescription-tracker.national.nhs.uk pointing to route 53 hosted zones in each account
